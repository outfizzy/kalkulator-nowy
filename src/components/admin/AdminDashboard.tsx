        ...
        sales: {
            ...
            actions: [
                ...
                },
                {
                    ...
                    description: 'Potencjalni klienci'
                },
                {
                    title: 'Poczta',
                    icon: (
                ...
                },
                {
                    ...
                    path: '/fairs',
                    color: 'bg-indigo-50 text-indigo-600',
                    description: 'Tryb Targowy (Tablet)'
                },
                {
                    title: 'Zarządzanie Targami',
                    icon: (
                        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    path: '/admin/fairs',
                    color: 'bg-indigo-50 text-indigo-600',
                    description: 'Edycja i tworzenie wydarzeń'
                }
            ]
        },
        team: {
            ...
            actions: [
                ...
                },
                {
                    ...
                    path: '/admin/b2b/partners',
                    color: 'bg-emerald-50 text-emerald-600',
                    description: 'Marże i warunki B2B'
                }
            ]
        },
        operations: {
