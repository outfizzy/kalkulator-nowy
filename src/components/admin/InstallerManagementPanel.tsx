...
export const InstallerManagementPanel: React.FC = () => {
    const [activeTab, setActiveTab] = useState<'installers' | 'teams'>('installers');
        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-slate-500 mt-1">Zarządzaj zespołami, monitoruj pracę i przypisane montaże</p>
                </div>
            </div>
            ...
            <div className="bg-white rounded-lg p-1 inline-flex border border-slate-200 shadow-sm">
                <button
                    ...
                    className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${activeTab === 'installers'
                ...
                <button
                    ...
                    className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${activeTab === 'teams'
                            ? 'bg-blue-50 text-blue-700 shadow-sm'
                            : 'text-slate-600 hover:bg-slate-50'
                        }`}
                >
