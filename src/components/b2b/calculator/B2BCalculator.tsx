...
// === COMPREHENSIVE GERMAN MODEL SPECIFICATIONS ===
// Detailed technical specs per model for PDF and summary display
const MODEL_DETAIL_SPECS: Record<string, Array<{ label: string; value: string }>> = {
    'Orangeline': [
        { label: 'Konstruktion', value: 'Aluminium 6063-T5' },
        { label: 'Profilhoehe', value: '50 mm (Sparren)' },
        { label: 'Pfostenquerschnitt', value: '110 x 110 mm' },
        { label: 'Neigung', value: '8\u00b0 fest (vorkonfiguriert)' },
        { label: 'Max. Breite', value: '7.000 mm' },
        { label: 'Max. Tiefe', value: '5.000 mm' },
        { label: 'Dacheindeckung', value: 'Polycarbonat 16mm / VSG Glas 8mm' },
        { label: 'Rinnentyp', value: 'Integrierte Kastenrinne 70mm' },
        { label: 'Oberflaeche', value: 'Pulverbeschichtung RAL nach Wahl' },
        { label: 'Entwasserung', value: 'Verdeckt in Pfosten' },
        { label: 'Montage', value: 'Wandmontage / Freistehend' },
        { label: 'Schneelastzone', value: 'Bis Zone 3 (SL 1,5 kN/m\u00b2)' },
        { label: 'Windlastzone', value: 'Bis 100 km/h' },
        { label: 'Garantie', value: '10 Jahre auf Konstruktion' },
    ],
    'Orangeline+': [
        { label: 'Konstruktion', value: 'Aluminium 6063-T5 verstaerkt' },
        { label: 'Profilhoehe', value: '60 mm (Sparren)' },
        { label: 'Pfostenquerschnitt', value: '110 x 110 mm' },
        { label: 'Neigung', value: '8\u00b0 fest (vorkonfiguriert)' },
        { label: 'Max. Breite', value: '7.000 mm' },
        { label: 'Max. Tiefe', value: '5.500 mm' },
        { label: 'Dacheindeckung', value: 'Polycarbonat 16mm / VSG Glas 8mm' },
        { label: 'Rinnentyp', value: 'Integrierte Kastenrinne 89mm' },
        { label: 'Oberflaeche', value: 'Pulverbeschichtung RAL nach Wahl' },
        { label: 'Entwasserung', value: 'Verdeckt in Pfosten' },
        { label: 'Montage', value: 'Wandmontage / Freistehend' },
        { label: 'Schneelastzone', value: 'Bis Zone 3 (SL 1,5 kN/m\u00b2)' },
        { label: 'Besonderheit', value: 'Verstaerkte Verbinder' },
        { label: 'Garantie', value: '10 Jahre auf Konstruktion' },
    ],
    'Trendline': [
        { label: 'Konstruktion', value: 'Aluminium 6063-T5' },
        { label: 'Profilhoehe', value: '60 mm (Sparren)' },
        { label: 'Sparrenhoehe', value: '47,5 mm (inkl. Dichtung)' },
        { label: 'Pfostenquerschnitt', value: '110 x 110 mm' },
        { label: 'Neigung', value: 'Variabel (berechnet aus H1/H3)' },
        { label: 'Max. Breite', value: '7.000 mm' },
        { label: 'Max. Tiefe', value: '5.000 mm' },
        { label: 'Dacheindeckung', value: 'Polycarbonat 16mm / VSG Glas 8mm' },
        { label: 'Rinnentyp', value: 'Kastenrinne Standard 112mm' },
        { label: 'Entwasserung', value: 'Verdeckt in Pfosten' },
        { label: 'Oberflaeche', value: 'Pulverbeschichtung RAL nach Wahl' },
        { label: 'Montage', value: 'Wandmontage / Freistehend' },
        { label: 'Schneelastzone', value: 'Bis Zone 3 (SL 1,5 kN/m\u00b2)' },
    ...
    'Trendline+': [
        { label: 'Konstruktion', value: 'Aluminium 6063-T5 verstaerkt' },
        { label: 'Profilhoehe', value: '70 mm (Sparren)' },
        { label: 'Sparrenhoehe', value: '57,5 mm (inkl. Dichtung)' },
        { label: 'Pfostenquerschnitt', value: '110 x 110 mm' },
        { label: 'Neigung', value: 'Variabel (berechnet aus H1/H3)' },
        { label: 'Max. Breite', value: '7.000 mm' },
        { label: 'Max. Tiefe', value: '5.500 mm' },
        ...
        { label: 'Oberflaeche', value: 'Pulverbeschichtung RAL nach Wahl' },
        { label: 'Montage', value: 'Wandmontage / Freistehend' },
        { label: 'Schneelastzone', value: 'Bis Zone 4 (SL 2,0 kN/m\u00b2)' },
        { label: 'Besonderheit', value: 'Erhoehte Tragfaehigkeit' },
        { label: 'Garantie', value: '10 Jahre auf Konstruktion' },
    ],
    'Topline': [
        { label: 'Konstruktion', value: 'Aluminium 6063-T6 Premium' },
        { label: 'Profilhoehe', value: '80 mm (Sparren)' },
        { label: 'Sparrenhoehe', value: '93,2 mm (inkl. Dichtung)' },
        { label: 'Pfostenquerschnitt', value: '149 x 149 mm' },
        { label: 'Neigung', value: 'Variabel (berechnet aus H1/H3)' },
        { label: 'Max. Breite', value: '10.000 mm' },
        { label: 'Max. Tiefe', value: '6.000 mm' },
        { label: 'Dacheindeckung', value: 'Polycarbonat 16mm / VSG Glas 10mm' },
        { label: 'Rinnentyp', value: 'Premium Kastenrinne 155mm' },
        { label: 'Entwasserung', value: 'Verdeckt in Pfosten (DN 75)' },
        { label: 'Oberflaeche', value: 'Pulverbeschichtung RAL nach Wahl' },
        { label: 'Montage', value: 'Wandmontage / Freistehend' },
        { label: 'Schneelastzone', value: 'Bis Zone 4 (SL 2,0 kN/m\u00b2)' },
        { label: 'Besonderheit', value: 'Grosse Spannweiten moeglich' },
        { label: 'Garantie', value: '10 Jahre auf Konstruktion' },
    ],
    'Topline XL': [
        { label: 'Konstruktion', value: 'Aluminium 6063-T6 Hochlast' },
        { label: 'Profilhoehe', value: '100 mm (Sparren)' },
        { label: 'Sparrenhoehe', value: '117 mm (inkl. Dichtung)' },
        { label: 'Pfostenquerschnitt', value: '196 x 196 mm' },
        { label: 'Neigung', value: 'Variabel (berechnet aus H1/H3)' },
        { label: 'Max. Breite', value: '14.000 mm' },
        { label: 'Max. Tiefe', value: '6.000 mm' },
        { label: 'Dacheindeckung', value: 'VSG Glas 10mm / Polycarbonat 16mm' },
        { label: 'Rinnentyp', value: 'Premium Kastenrinne 155mm' },
        { label: 'Entwasserung', value: 'Verdeckt in Pfosten (DN 100)' },
        { label: 'Oberflaeche', value: 'Pulverbeschichtung RAL nach Wahl' },
        { label: 'Montage', value: 'Wandmontage' },
        { label: 'Schneelastzone', value: 'Bis Zone 5 (SL 2,5+ kN/m\u00b2)' },
        { label: 'Besonderheit', value: 'Extra grosse Konstruktionen bis 14m' },
        { label: 'Garantie', value: '10 Jahre auf Konstruktion' },
    ],
    'Designline': [
        { label: 'Konstruktion', value: 'Aluminium 6063-T6 Design' },
        { label: 'Profilhoehe', value: '93 mm (Sparren, flaches Design)' },
        { label: 'Pfostenquerschnitt', value: '196 x 196 mm' },
        { label: 'Neigung', value: 'Variabel (berechnet aus H1/H3)' },
        { label: 'Max. Breite', value: '10.000 mm' },
        { label: 'Max. Tiefe', value: '6.000 mm' },
        { label: 'Dacheindeckung', value: 'VSG Glas 10mm (nur Glas)' },
        { label: 'Rinnentyp', value: 'Integrierte Designrinne' },
        { label: 'Entwasserung', value: 'Verdeckt in Pfosten (DN 75)' },
        { label: 'Oberflaeche', value: 'Pulverbeschichtung RAL nach Wahl' },
        { label: 'Montage', value: 'Wandmontage / Freistehend' },
        { label: 'Schneelastzone', value: 'Bis Zone 4 (SL 2,0 kN/m\u00b2)' },
        { label: 'Besonderheit', value: 'Minimalistisches, modernes Design' },
        { label: 'Schiebeeinheit', value: 'Optional: Glasschiebeanlage' },
        { label: 'Garantie', value: '10 Jahre auf Konstruktion' },
    ],
    'Ultraline': [
        { label: 'Konstruktion', value: 'Aluminium 6063-T6 Oberklasse' },
        { label: 'Profilhoehe', value: '100 mm (mit Dachueberhang)' },
        { label: 'Pfostenquerschnitt', value: '196 x 196 mm' },
        { label: 'Neigung', value: 'Berechnet mit Dachueberhang (U1)' },
        { label: 'Max. Breite', value: '14.000 mm' },
        { label: 'Max. Tiefe', value: '6.000 mm' },
        { label: 'Dacheindeckung', value: 'VSG Glas 10mm (nur Glas)' },
        { label: 'Rinnentyp', value: 'Premium Alu-Rinne verdeckt' },
        { label: 'Entwasserung', value: 'Im Pfosten integriert (DN 100)' },
        { label: 'Oberflaeche', value: 'Pulverbeschichtung RAL nach Wahl' },
        { label: 'Montage', value: 'Wandmontage mit Naddach' },
        { label: 'Schneelastzone', value: 'Bis Zone 5 (SL 2,5+ kN/m\u00b2)' },
        { label: 'Besonderheit', value: 'Dachueberhang Classic/Style' },
        { label: 'LED Beleuchtung', value: 'Optional: LED-Spots integrierbar' },
        { label: 'Garantie', value: '10 Jahre auf Konstruktion' },
    ],
    'Skyline': [
        { label: 'Konstruktion', value: 'Aluminium 6063-T6 Bioklimatisch' },
        { label: 'Lamellenbreite', value: 'Aluminium Lamellen drehbar' },
        { label: 'Pfostenquerschnitt', value: '160 x 160 mm' },
        { label: 'Neigung', value: 'Flach 0\u00b0 (Lamellen einstellbar)' },
        { label: 'Max. Breite', value: '7.000 mm' },
        { label: 'Max. Tiefe', value: '5.000 mm' },
        { label: 'Dachsystem', value: 'Drehbare Alu-Lamellen (0-135\u00b0)' },
        { label: 'Rinnentyp', value: 'Integriert in Lamellensystem' },
        { label: 'Entwasserung', value: 'Automatisch ueber Lamellen' },
        { label: 'Oberflaeche', value: 'Pulverbeschichtung RAL nach Wahl' },
        { label: 'Montage', value: 'Wandmontage / Freistehend' },
        { label: 'Windlast', value: 'Bis 130 km/h (geschlossen)' },
        { label: 'Besonderheit', value: 'Regen- u. Sonnenschutz in einem' },
        { label: 'Steuerung', value: 'Optional: Motorantrieb + Fernbed.' },
        { label: 'Garantie', value: '10 Jahre auf Konstruktion' },
    ],
    'Carport': [
        { label: 'Konstruktion', value: 'Aluminium 6063-T6 Carport' },
        { label: 'Lamellenbreite', value: 'Alu-Lamellen fest/drehbar' },
        { label: 'Pfostenquerschnitt', value: '160 x 160 mm' },
        { label: 'Neigung', value: 'Flach 0\u00b0' },
        { label: 'Max. Breite', value: '10.000 mm' },
        { label: 'Max. Tiefe', value: '6.000 mm' },
        { label: 'Dachsystem', value: 'Carport-Lamellen (wetterfest)' },
        { label: 'Rinnentyp', value: 'Integrierte Kastenrinne' },
        { label: 'Entwasserung', value: 'Verdeckt in Pfosten' },
        { label: 'Oberflaeche', value: 'Pulverbeschichtung RAL nach Wahl' },
        { label: 'Montage', value: 'Wandmontage / Freistehend' },
        { label: 'Schneelastzone', value: 'Bis Zone 3 (SL 1,5 kN/m\u00b2)' },
        { label: 'Besonderheit', value: 'Doppel-Carport moeglich' },
        { label: 'Garantie', value: '10 Jahre auf Konstruktion' },
    ],
};
    ...
    const handleGenerateClientPDF = async () => {
        try {
            ...
            const pdfConfig: B2BPDFConfig = {
                ...
                modelDetailSpecs: MODEL_DETAIL_SPECS[model] || undefined
            };
