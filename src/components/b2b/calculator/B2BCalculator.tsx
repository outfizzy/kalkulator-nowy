...
const ROOF_MODELS: RoofModel[] = [
    ...
    { id: 'Topline XL', name: 'Topstyle XL', description: 'Extra duże konstrukcje • profil 100mm • do 14m szer. • słupki 196mm', hasPoly: true, hasGlass: true, hasFreestanding: true, image_url: '/images/models/toplinexl.webp',
      specs: { profileMm: '100mm', angleType: 'zmienny', postMm: 196, maxWidth: 14000, maxDepth: 6000, dachrechnerKey: 'topline_xl' } },
    { id: 'Designline', name: 'Designstyle', description: 'Zadaszenie z przesuwnym szklanym dachem • profil 93mm • nowoczesny design • tylko szkło', hasPoly: false, hasGlass: true, hasFreestanding: true, image_url: '/images/models/designline.jpg',
...
// Only data confirmed from dachrechner.service.ts and ROOF_MODELS catalog
// Sources: postWidth, profileHeight constants, fixedAngle, maxWidth/maxDepth, hasPoly/hasGlass/hasFreestanding
const MODEL_DETAIL_SPECS: Record<string, Array<{ label: string; value: string }>> = {
    'Orangeline': [
        { label: 'Konstruktion', value: 'Aluminium Profil' },
        { label: 'Profilhoehe (Sparren)', value: '50 mm' },
        { label: 'Pfostenquerschnitt', value: '110 x 110 mm' },
        { label: 'Keilhoehe (K)', value: '39 mm' },
        { label: 'Neigung', value: '8\u00b0 fest' },
        { label: 'Max. Breite', value: '7.000 mm' },
        { label: 'Max. Tiefe', value: '5.000 mm' },
        { label: 'Dacheindeckung', value: 'Polycarbonat / VSG Glas' },
        { label: 'Montage', value: 'Wandmontage' },
        { label: 'Oberflaeche', value: 'Pulverbeschichtung RAL' },
    ],
    'Orangeline+': [
        { label: 'Konstruktion', value: 'Aluminium Profil (verstaerkt)' },
        { label: 'Profilhoehe (Sparren)', value: '60 mm' },
        { label: 'Pfostenquerschnitt', value: '110 x 110 mm' },
        { label: 'Keilhoehe (K)', value: '34 mm' },
        { label: 'Neigung', value: '8\u00b0 fest' },
        { label: 'Max. Breite', value: '7.000 mm' },
    ...
    'Trendline': [
        { label: 'Konstruktion', value: 'Aluminium Profil' },
        { label: 'Profilhoehe (Sparren)', value: '60 mm' },
        { label: 'Sparrenhoehe (Profil)', value: '47,5 mm' },
        { label: 'Keilhoehe (K)', value: '39 mm' },
        { label: 'Pfostenquerschnitt', value: '110 x 110 mm' },
    ...
    'Trendline+': [
        { label: 'Konstruktion', value: 'Aluminium Profil (verstaerkt)' },
        { label: 'Profilhoehe (Sparren)', value: '70 mm' },
        { label: 'Sparrenhoehe (Profil)', value: '57,5 mm' },
        { label: 'Keilhoehe (K)', value: '50,1 mm' },
        { label: 'Pfostenquerschnitt', value: '110 x 110 mm' },
        { label: 'Neigung', value: 'Variabel (berechnet aus H1/H3)' },
        { label: 'Max. Breite', value: '7.000 mm' },
        { label: 'Max. Tiefe', value: '5.500 mm' },
    ...
    'Topline': [
        { label: 'Konstruktion', value: 'Aluminium Profil Premium' },
        { label: 'Profilhoehe (Sparren)', value: '80 mm' },
        { label: 'Sparrenhoehe (Profil)', value: '93,2 mm' },
        { label: 'Keilhoehe (K)', value: '84 mm' },
        { label: 'Tiefe-Offset (depthOffset)', value: '155 mm' },
    ...
    'Topline XL': [
        { label: 'Konstruktion', value: 'Aluminium Profil Hochlast' },
        { label: 'Profilhoehe (Sparren)', value: '100 mm' },
        { label: 'Sparrenhoehe (Profil)', value: '117 mm' },
        { label: 'Keilhoehe (K)', value: '106 mm' },
        { label: 'Tiefe-Offset (depthOffset)', value: '155 mm' },
    ...
    'Designline': [
        { label: 'Konstruktion', value: 'Aluminium Profil Design' },
        { label: 'Profilhoehe (Sparren)', value: '93 mm' },
        { label: 'Keilhoehe (K)', value: '93 mm' },
        { label: 'Pfostenquerschnitt', value: '196 x 196 mm' },
        { label: 'Neigung', value: 'Variabel (berechnet aus H1/H3)' },
        { label: 'Max. Breite', value: '10.000 mm' },
        { label: 'Max. Tiefe', value: '6.000 mm' },
        { label: 'Dacheindeckung', value: 'VSG Glas (Schiebedach / verschiebbar)' },
        { label: 'Montage', value: 'Wandmontage / Freistehend' },
        { label: 'Oberflaeche', value: 'Pulverbeschichtung RAL' },
    ],
    'Ultraline': [
        { label: 'Konstruktion', value: 'Aluminium Profil mit Dachueberhang' },
        { label: 'Profilhoehe (Sparren)', value: '100 mm' },
        { label: 'Pfostenquerschnitt', value: '196 x 196 mm' },
        { label: 'Dachueberhang (U1)', value: 'Classic: variabel / Style: 120 mm fest' },
        { label: 'Neigung', value: 'Berechnet mit Dachueberhang' },
        { label: 'Max. Breite', value: '14.000 mm' },
        { label: 'Max. Tiefe', value: '6.000 mm' },
    ...
    'Skyline': [
        { label: 'Konstruktion', value: 'Aluminium Lamellendach' },
        { label: 'Lamellenwinkelhoehe', value: '95 mm (glassAngleHeight)' },
        { label: 'Pfostenquerschnitt', value: '160 x 160 mm' },
        { label: 'Neigung', value: 'Flach (Lamellen drehbar)' },
        { label: 'Max. Breite', value: '7.000 mm' },
        { label: 'Max. Tiefe', value: '5.000 mm' },
        { label: 'Dachsystem', value: 'Drehbare Aluminium-Lamellen' },
        { label: 'Montage', value: 'Wandmontage / Freistehend' },
        { label: 'Oberflaeche', value: 'Pulverbeschichtung RAL' },
    ],
    'Carport': [
        { label: 'Konstruktion', value: 'Aluminium Carport' },
        { label: 'Lamellenwinkelhoehe', value: '28 mm (glassAngleHeight)' },
        { label: 'Pfostenquerschnitt', value: '160 x 160 mm' },
        { label: 'Neigung', value: 'Flach' },
        { label: 'Max. Breite', value: '10.000 mm' },
        { label: 'Max. Tiefe', value: '6.000 mm' },
        { label: 'Dachsystem', value: 'Carport-Lamellen' },
        { label: 'Montage', value: 'Wandmontage / Freistehend' },
        { label: 'Oberflaeche', value: 'Pulverbeschichtung RAL' },
    ],
};
