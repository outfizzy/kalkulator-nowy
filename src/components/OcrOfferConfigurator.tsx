      ...
      <section className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
        ...
        {step === 'review' && (
          <div className="space-y-6">
                    ...
                    {scannedItems.length === 0 && (
                      <tr>
                        <td colSpan={5} className="p-8 text-center text-slate-400">
                          ...
                          <p>Brak pozycji. Załaduj dokument lub dodaj ręcznie.</p>
                        </td>
                      </tr>
                    )}
                  </tbody>
            ...
            {/* Add item button */}
            <button
              onClick={() => setScannedItems(prev => [...prev, { name: '', quantity: 1, unit: 'szt', price: 0, total: 0 }])}
              className="w-full py-2.5 border-2 border-dashed border-slate-300 hover:border-indigo-400 rounded-xl text-sm font-bold text-slate-500 hover:text-indigo-600 hover:bg-indigo-50/50 transition-all flex items-center justify-center gap-2"
            >
